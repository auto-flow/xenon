...
from neutron.optimizer.bo.sampling_sort_opt import SamplingSortOptimizer
from neutron.utils.config_transformer import ConfigTransformer


class SMACOptimizer(SamplingSortOptimizer):
    def __init__(
            self,
            # model related
            forest_type="ET",
    ...
    def initialize(self, config_space, budgets=(1,), random_state=42, initial_points=None, budget2obvs=None):
        super(SMACOptimizer, self).initialize(config_space, budgets, random_state, initial_points,
                                              budget2obvs)
