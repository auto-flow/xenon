...
from neutron.async_comm.master import Master
from neutron.async_comm.nameserver import NameServer
from neutron.async_comm.worker import Worker
from neutron.facade.result import FMinResult
from neutron.facade.utils import warm_start_optimizer, get_wanted
from neutron.hdl import hdl2cs
from neutron.multi_fidelity import BaseIterGenerator, CustomIterGenerator
from neutron.optimizer.base_opt import BaseOptimizer
from neutron.utils import progress
from neutron.utils.misc import dump_checkpoint
...
def fmin(
    ...
    if inspect.isclass(optimizer):
        ...
        try:
            opt_ = getattr(importlib.import_module("neutron.optimizer"),
