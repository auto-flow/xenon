...
from neutron.facade.utils import get_wanted
from neutron.multi_fidelity.iter import WarmStartIteration
from neutron.multi_fidelity.iter_gen.base_gen import BaseIterGenerator
from neutron.optimizer.base_opt import BaseOptimizer
from neutron.utils.logging_ import get_logger
from neutron.utils.progress import no_progress_callback
...
class Master(object):
    def __init__(self,
        ...
        optimizer: neutron.optimizer.base_opt.BaseOptimizer object
