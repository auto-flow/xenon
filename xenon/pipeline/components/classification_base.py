...
from xenon.pipeline.components.base import XenonComponent
from xenon.utils.data import softmax, densify
from xenon.utils.ml_task import get_ml_task_from_y


class XenonClassificationAlgorithm(XenonComponent):
