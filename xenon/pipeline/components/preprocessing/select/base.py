...
from xenon.utils.dataframe import DataFrameValuesWrapper
...
class SelectFromModelBase(SklearnSelectMixin, XenonFeatureEngineerAlgorithm):
...
class REF_Base(SklearnSelectMixin, XenonFeatureEngineerAlgorithm):
    class__ = "RFE"
    module__ = "sklearn.feature_selection"
    need_y = True
...
class SelectPercentileBase(SklearnSelectMixin, XenonFeatureEngineerAlgorithm):
