...
from xenon.constants import PHASE2, PHASE1
...
from xenon.utils.dict import group_dict_items_before_first_dot
...
from xenon.utils.sys import get_trance_back_msg
...
class TrainEvaluator(BaseEvaluator):
    ...
    def get_Xy(self):
        # fixme: 会出现结果被改变的情况！  目前这个bug在xenon.pipeline.components.preprocessing.operate.merge.Merge 出现过
