...
class TrainEvaluator(BaseEvaluator):
    ...
    def get_Xy(self):
        # fixme: 会出现结果被改变的情况！
        #  目前这个bug在xenon.workflow.components.preprocessing.operate.keep_going.KeepGoing 出现过
        # fixme: xenon.manager.data_container.dataframe.DataFrameContainer#sub_sample 函数采用deepcopy，
