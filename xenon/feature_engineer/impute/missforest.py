...
from xenon.feature_engineer.impute.utils import process_dataframe, parse_cat_col, build_encoder, decode_data
...
class MissForest(BaseEstimator, TransformerMixin):
    ...
    * [3] https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.
    ...
    Examples
    --------
    >>> from xenon.feature_engineer.impute.missforest import MissForest
    >>> nan = float("NaN")
