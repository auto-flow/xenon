...
from xenon.feature_engineer.impute.utils import process_dataframe, parse_cat_col, build_encoder, encode_data, decode_data
from xenon.feature_engineer.impute.wrapped_encodes.target_encoder import TargetEncoder
...
class KNNImputer(BaseEstimator, TransformerMixin):
    ...
    * Olga Troyanskaya, Michael Cantor, Gavin Sherlock, Pat Brown, Trevor
    ...
    Examples
    --------
    >>> from xenon.feature_engineer.impute import KNNImputer
    >>> nan = float("NaN")
    ...
    def transform(self, X):
        ...
        if self.do_simple_imputing:
            ...
            from xenon.feature_engineer.impute import AdaptiveSimpleImputer
