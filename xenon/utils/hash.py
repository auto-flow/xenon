...
from xenon.utils.dataframe import get_object_columns
...
if __name__ == '__main__':
    ...
    start = time()
    ans = get_file_md5("/data/Project/AutoML/Xenon_v2.0/scripts/savedpath/train_full.csv")
    ans2 = get_file_md5("/data/Project/AutoML/Xenon_v2.0/scripts/savedpath/train_full.csv")
    print(ans)
    print(ans == ans2)
    print(time() - start)
