...
from xenon.hdl.utils import is_hdl_bottom
        ...
        for item in value:
            ...
            for name, forbidden_values in item.items():
                ...
                if isinstance(forbidden_values, list):
                    clauses.append(ForbiddenInClause(store[name], list(map(smac_hdl._encode, forbidden_values))))
                else:
                    clauses.append(ForbiddenEqualsClause(store[name], smac_hdl._encode(forbidden_values)))
