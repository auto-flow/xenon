...
from xenon.utils.math import get_int_length
...
class HDL_Constructor(StrSignatureMixin):
    ...
    def __init__(
        ...
        hdl_bank_path: str, default=None
            ...
            ``hdl_bank_path`` is this file's path. If it is None, ``xenon/hdl/hdl_bank.json`` will be choosed.
        ...
        ml_task: :class:`xenon.utils.ml_task.MLTask`
