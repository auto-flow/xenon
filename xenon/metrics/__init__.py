...
pac_score = make_scorer('pac_score',
                        ...
                        needs_proba=True)
auc = make_scorer("auc", sklearn.metrics.roc_auc_score, needs_threshold=True)
# TODO cohen_kappa
...
for scorer in [
    ...
    balanced_accuracy, pac_score, mcc, sensitivity, specificity, auc
]:
...
def calculate_score(solution, prediction, mainTask, metric=None,
                    should_calc_all_metric=False, verbose=False):
