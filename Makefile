sync_neutron:
	rm -rf ../neutron/neutron || cp -r  ./neutron ../neutron/neutron
...
change_pip_source:
	mkdir ${HOME}/.pip -p || exit 0
	wget https://gitee.com/TQCAI/misc/raw/master/douban_pip_source -O ${HOME}/.pip/pip.conf
