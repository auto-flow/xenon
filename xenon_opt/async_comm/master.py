...
from xenon_opt.facade.utils import get_wanted
from xenon_opt.multi_fidelity.iter import WarmStartIteration
from xenon_opt.multi_fidelity.iter_gen.base_gen import BaseIterGenerator
from xenon_opt.optimizer.base_opt import BaseOptimizer
from xenon_opt.utils.logging_ import get_logger
from xenon_opt.utils.progress import no_progress_callback
...
class Master(object):
    def __init__(self,
        ...
        optimizer: xenon_opt.optimizer.base_opt.BaseOptimizer object
