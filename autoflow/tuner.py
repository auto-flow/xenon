...
import numpy as np
from autoflow.lazy_import import ConfigurationSpace, Configuration
...
class Tuner(StrSignatureMixin):
    ...
    def __init__(
        ...
        evaluator: callable, str
            ...
            ``evaluator`` can receive a shp(ETPE Hyper Param, :class:`ConfigSpace.ConfigurationSpace`),
        ...
        search_method: str
            Specific searching method, ``random``, ``smac``, ``grid`` are available.
                ...
                * ``smac``   Bayes Search by ETPE Algorithm.
        ...
        initial_runs: int
            ...
            you should realize the ETPE algorithm has a initialize procedure,
