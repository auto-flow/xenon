# 确保在xenon顶层目录
# sh tests/create_mock_data_for_display_develop/search_origin_digits.sh
export PYTHONPATH=$PYTHONPATH:$PWD
export DATAPATH=tests/datasets/digits.csv
export SAVEDPATH=savedpath/multi-classification/search_origin_digits
rm -rf $SAVEDPATH
mkdir -p $SAVEDPATH
export USER_ID=2
