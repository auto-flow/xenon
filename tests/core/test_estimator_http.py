...
from xenon import HDL_Constructor, NdArrayContainer
from xenon.core.classifier import XenonClassifier
from xenon.ensemble.stack.classifier import StackClassifier
...
from xenon.data_container.dataframe import DataFrameContainer
import numpy as np
...
class TestEstimatorsHttp(LocalResourceTestCase):
    ...
    def get_server_dir(self):
        server_dir = (Path(__file__).parent.parent.parent / "xenon_server").as_posix()
        return server_dir
