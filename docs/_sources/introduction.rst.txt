...
.. note::
    You can find ``column_descriptions``'s definition in :class:`xenon.manager.data_manager.DataManager`

If some ``features`` have similar properties, they are containing in a same ``feature group``.

.. note::
    You can find some ``feature group``'s examples and practices in :class:`xenon.hdl.hdl_constructor.HDL_Constructor`
...
**First step**, data manager(:class:`xenon.manager.data_manager.DataManager`) split raw data into three
